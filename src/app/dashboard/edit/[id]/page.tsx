  ...
  useEffect(() => {
    async function load() {
      ...
      setForm({
        ...
        progress_episode: data.entry.progress_episode ? String(data.entry.progress_episode) : '',
      ...
      <form onSubmit={handleSave} className="max-w-lg space-y-5">
        ...
        {form.type === 'series' && (
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-text-primary mb-1.5">Episode</label>
              <input
                type="number"
                min="1"
