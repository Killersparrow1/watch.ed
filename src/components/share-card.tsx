              ...
              <div style={{ marginTop: 6, display: 'flex', flexWrap: 'wrap', gap: 4 }}>
                ...
                {entry.badge === 'MalamCult' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 3, padding: '3px 7px', backgroundColor: 'rgba(190,18,60,0.15)', borderRadius: 4, fontSize: 9, color: '#BE123C', fontWeight: 800 }}>
                    <svg viewBox="0 0 20 20" style={{ width: 10, height: 10 }} fill="currentColor"><path d="M10 2C5 2 2 6 2 10s3 8 8 8 8-4 8-8-3-8-8-8zM7 9c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1zm6 0c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1zm-5 5c-.6 0-1-.4-1-1s.4-1 1-1h4c.6 0 1 .4 1 1s-.4 1-1 1H8z"/></svg>
                    MalamCult
                  </div>
                )}
                {entry.badge === 'wammale cinema' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 3, padding: '3px 7px', backgroundColor: 'rgba(14,116,144,0.15)', borderRadius: 4, fontSize: 9, color: '#0E7490', fontWeight: 800 }}>
                    <svg viewBox="0 0 20 20" style={{ width: 10, height: 10 }} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 16V5h3"/><path d="M17 16V5h-3"/><path d="M3 5h2"/><path d="M17 5h-2"/></svg>
                    wammale cinema
                  </div>
                )}
              </div>
